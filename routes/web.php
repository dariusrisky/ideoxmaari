...
Route::middleware('auth')->group(function () {
    ...
    Route::get('slider/addslider',[IklanController::class,'addslider'])->name('addslider');
    ...
    Route::get('slider/edit/{id}',[IklanController::class,'edit'])->name('image.edit');
    Route::put('slider/edit/{product_img}',[IklanController::class,'editNew'])->name('image.edit.action');
    Route::post('slider/priority/',[IklanController::class,'priority'])->name('priority');
